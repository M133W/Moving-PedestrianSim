...
public class Inter_varMinus_3s : MonoBehaviour
{
            ...
            foreach (GameObject VehicleGroup in controller.CarsGroups)
            {
                switch (VehicleGroup.tag)
                {
                    ...
                    case "C2":
                        ...
                        // SetSpawnSpacingForCarGroup(VehicleGroup, 9f);
                        break;
                    case "C3":
                        SetSpeedForCarGroup(VehicleGroup, 50f);
                        // SetSpawnSpacingForCarGroup(VehicleGroup, 6.6f);
                        break;
                    case "C4":
                        SetSpeedForCarGroup(VehicleGroup, 60f);
                        // SetSpawnSpacingForCarGroup(VehicleGroup, 5.4f);
                        break;
                    default:
